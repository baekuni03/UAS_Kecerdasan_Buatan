...
<div class="content">
    ...
    <div class="typo-w3">
        <div class="container">
            ...
            <h3 class="typoh2"> == </h3>
            <h3 class="typoh2">Di Susun Oleh : Baekuni</h3>
            <h3 class="typoh2">NIM : 171011400597</h3>
            <h3 class="typoh2">Kelas : 06TPLM006</h3>
            <h3 class="typoh2">Mata Kuliah : Kecerdasan Buatan</h3>
            <h3 class="typoh2"> == </h3>
            <br>
            <p>
